...
const canvasContainer = document.getElementById('target')
const outputContainer = document.getElementById('output')
const {canvas: c1, wrapper: cw1} = createCanvas(1000, 800)
const {canvas: c2, wrapper: cw2}  = createCanvas(1000, 800)
attachCanvas(cw1, canvasContainer)
attachCanvas(cw2, canvasContainer)


window.stdout = new Output(outputContainer);

const lkTour = linKernighan(nodes);
finalTour = twoOpt(lkTour)
stdout.println("Final Tour: " + finalTour.toString());

drawEdges(c1, nodes);
drawEdges(c2, lkTour.path);
